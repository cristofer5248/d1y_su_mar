...
//		List<Producto> producto = extracted(model);
		...
		CellStyle tbodystyleright = workbook.createCellStyle();
		tbodystyleright.setBorderBottom(BorderStyle.MEDIUM);
		tbodystyleright.setBorderRight(BorderStyle.MEDIUM);
		tbodystyleright.setBorderLeft(BorderStyle.MEDIUM);
		tbodystyleright.setBorderTop(BorderStyle.MEDIUM);
		tbodystyleright.setAlignment(HorizontalAlignment.RIGHT);
...
//		filatotal.createCell(10).setCellType(CellType.STRING);
		...
		filatotal.createCell(10).setCellStyle(tbodystyle);
		filatotal.createCell(0).setCellValue("Total:  ");
		filatotal.getCell(0).setCellStyle(tbodystyleright);
